...
document.querySelector("#apply").addEventListener("click", function () {
  ...
  document.querySelector("#column2 .title").style.color =
    fontColor(doing_color);
...
document.querySelector("#btn_task").style.backgroundColor =
  localStorage.getItem("toDo_color");
document.querySelector("#background_color").value =
  localStorage.getItem("background_color");
document.querySelector("#toDo_color").value =
  localStorage.getItem("toDo_color");
document.querySelector("#doing_color").value =
  localStorage.getItem("doing_color");
document.querySelector("#done_color").value =
  localStorage.getItem("done_color");
document.querySelector("#column1 .title").style.color = fontColor(
  localStorage.getItem("toDo_color")
);
document.querySelector("#column2 .title").style.color = fontColor(
  localStorage.getItem("doing_color")
);
document.querySelector("#column3 .title").style.color = fontColor(
  localStorage.getItem("done_color")
);
document.querySelector("#btn_task").style.color = fontColor(
  localStorage.getItem("toDo_color")
);
...
document
  ...
  .addEventListener("click", function () {
    ...
    document.querySelector("#column1 .title").style.color =
      fontColor("#f1f2f4");
    document.querySelector("#column2 .title").style.color =
      fontColor("#f1f2f4");
    document.querySelector("#column3 .title").style.color =
      fontColor("#f1f2f4");
